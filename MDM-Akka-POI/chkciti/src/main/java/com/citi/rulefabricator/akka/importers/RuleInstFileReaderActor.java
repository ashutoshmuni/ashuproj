...
//    private TaskService taskService;
    ...
    /** The Constant LOGGER. */
    private static final Logger LOGGER = LoggerFactory.getLogger(RuleInstFileReaderActor.class);
    ...
    public void processImport(final ImportDTO<RuleDef> mapDataImportDTO) {
        ...
        TaskDTO taskDTO = new TaskDTO();//taskService.findOne(taskId);

        importFilePath = "PATH";//taskDTO.getFilePath();
